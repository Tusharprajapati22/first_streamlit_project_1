...
st.title("STREAMLIT FULL COURSE(Title)")
st.header("Tushar Prajapati(Header)")
st.subheader("5 min engineering(Sub-Header)")
st.write("Ultimate AI Bootcamp(Text)")
st.markdown("By shridhar sir(Markdown)")
st.caption("STREAMLIT All Concepts(Caption)")
